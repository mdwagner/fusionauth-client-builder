[#function convertType type language]
  ...
  [#elseif language == "crystal"]
    ...
    [#elseif type == "String" || type == "ZoneId" || type == "Locale" || type == "LocalDate"]
      [#return "String"/]
    [#elseif type == "Object" || type == "D" || type == "T" || type == "HashMap" || type == "TreeMap" || type == "LinkedHashMap" || type == "Map"]
      [#return "JSON::Any"/]
    [#elseif type == "SortedSet"]
      [#return "Array"/]
    [#elseif type?starts_with("Collection")]
      [#return type?replace("Collection", "Array")?replace("<", "(")?replace(">", ")")/]
    [#elseif type == "boolean" || type == "Boolean"]
      [#return "Bool"/]
    [#elseif type == "int" || type == "Integer"]
      [#return "Int32"/]
